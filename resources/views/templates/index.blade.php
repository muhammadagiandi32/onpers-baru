...
<head>
    ...
    <style>
        @media (max-width: 768px) {
            .custom-video-height {
                height: 250px;
                /* Mengurangi tinggi video di mobile */
            }

            .ad-banner img {
                max-height: 200px;
                /* Menyesuaikan tinggi gambar iklan di mobile */
            }
        }
    ...
    <style>
        ...
        .tn-right .tn-img img {
            width: 100%;
            /* Agar gambar menyesuaikan dengan container */
            height: 300px;
            /* Atur tinggi tetap untuk semua gambar */
            object-fit: cover;
        ...
        @media (max-width: 768px) {
            ...
            .card-img-overlay h5 {
                font-size: 14px;
                /* Perkecil teks agar lebih mudah dibaca */
            }
        }
...
<body>
    <div class="main-content">
        ...
        <header class="header">
            <div class="container d-flex justify-content-between align-items-center">
                <a href="{{ url('/') }}"
                    class="navbar-brand text-white font-weight-bold d-flex align-items-center">
                                            ...
                                            <div class="card border-dark"
                                                ...
                                                <div class="card-body text-center p-4 p-xxl-5">
                                                    <svg fill="#ff6f61" width="48" height="48"
                                                        ...
                                                        class="bi bi-eraser-fill text-primary mb-4"
                                                        viewBox="0 0 448 512">
                                                        <path
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="card border-dark"
                                                ...
                                                <div class="card-body text-center p-4 p-xxl-5">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="48"
                                                        height="48" fill="#ff6f61"
                                                        class="bi bi-diamond-half text-primary mb-4"
                                                        viewBox="0 0 16 16">
                                                        <path
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="position-relative">
                                    <button class="slider-btn left-btn"
                                        data-category="{{ $category['slug'] }}">&#10094;</button>
                                    <button class="slider-btn right-btn"
                                        data-category="{{ $category['slug'] }}">&#10095;</button>

                                    <div class="d-flex overflow-hidden slider-container"
                                        ...
                                        @foreach ($category['items'] as $item)
                                            <div class="flex-shrink-0 slider-item">
                                                <div class="card position-relative border-0 overflow-hidden">
                                                    <img src="{{ $item->image_url }}" class="h-100 w-100"
                                                        alt="{{ $item->title }}">
                                                    <div
                                                        class="card-img-overlay d-flex flex-column justify-content-end">
                                                        <a
                                                            href="{{ $category['slug'] === 'acara' ? route('event-details', $item->slug) : route('news-details', $item->slug) }}">
    ...
    <footer class="footer mt-3">
        <div class="container">
            <p class="mb-0 putih">Copyright &copy; <strong class="brand-text">onPers</strong>. All Rights Reserved.
            </p>
        </div>
    </footer>
        ...
        function setupAllSliders() {
            document.querySelectorAll(".slider-container").forEach(slider => {
                ...
                let prevBtn = document.querySelector(
                    `.slider-btn.left-btn[data-category="${category}"]`);
                let nextBtn = document.querySelector(
                    `.slider-btn.right-btn[data-category="${category}"]`);
