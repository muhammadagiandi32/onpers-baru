                    ...
                    <div class="row tn-slider">
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                ...
                                <div class="tn-title">
                                    <a href="">Integer hendrerit elit eget purus
                                        sodales maximus</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="mn-list">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="">Morbi id finibus diam vel pretium
                                    enim</a>
                            </li>
                            <li>
                                <a href="">Duis semper sapien in eros euismod
                                    sodales</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="">Morbi ullamcorper vulputate metus non
                                    eleifend</a>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>
                        Copyright &copy; <a href="">Your Site Name</a>. All
                        Rights Reserved
                    </p>
                </div>
