        ...
        $('#table1').DataTable({
            ...
            ajax: {
                ...
                dataSrc: function (json) {
                    console.log(json); // Ini akan menampilkan data yang diterima dari server di konsol browser
                    return json.data;  // Pastikan untuk mengembalikan data yang sesuai dengan struktur yang diharapkan oleh DataTables
                }
            },
            columns: [
