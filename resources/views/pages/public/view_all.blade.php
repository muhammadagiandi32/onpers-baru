...
<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        @endphp
        <form action="{{ route('category.viewAll', $currentCategory) }}" method="GET" class="b-search d-flex align-items-center">
    ...
    @foreach($newsItems as $news)
        <div class="col-md-4 mb-4">
            <div class="card position-relative border-0 overflow-hidden" style="height: 200px; border-radius: 12px;">
                <img src="{{ $news->image_url }}" class="h-100 w-100" alt="{{ $news->title }}" style="object-fit: cover; border-radius: 12px;">
